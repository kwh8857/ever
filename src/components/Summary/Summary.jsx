        ...
        <div className="content-wrapper">
          ...
          <div className="sub">
            {type === "aircon" ? (
              agent !== "mb" ? (
                <>
                  에어컨 작동시 냉각핀은 습도가 높고 먼지 및 오염물질이 있는
                ...
                <>
                  에어컨 작동시 냉각핀은 습도가 높고 먼지 및 오염 <br /> 물질이
              ...
              <>
                잠을 잘 때 우리 몸의 모공에서는 많은 노폐물이
                {agent === "mb" ? <br /> : undefined} 배출이 됩니다.{" "}
                {agent !== "mb" ? <br /> : undefined}
                매트리스에 조금씩 스며든 노폐물은{" "}
                {agent === "mb" ? <br /> : undefined}
                <b>
                  박테리아 및 각종 세균과 {agent !== "mb" ? <br /> : undefined}{" "}
                  집먼지 진드기가 번식하기 {agent === "mb" ? <br /> : undefined}
                  좋은 환경
                </b>{" "}
                이 됩니다. 특히나 위험한 {agent !== "mb" ? (
                  <br />
                ) : undefined}{" "}
                집먼지{" "}
                <b>
                  진드기의{agent === "mb" ? <br /> : undefined} 배설물과
                  사체잔해가 아토피,천식,비염과 같은 <br /> 각종 알르레기성
                  질환을 유발
                </b>
                하게 됩니다.
              </>
              ...
              <>
                기존 백시멘트는 비위생적이고 오염이 쉽게 되며,
                {agent !== "pc" ? <br /> : undefined} 파손이 잘됩니다.{" "}
                {agent === "pc" ? <br /> : undefined}
                백시멘트가{" "}
                <b>
                  파손되어 나오는 {agent === "mb" ? <br /> : undefined} 가루는
                  각종
                  {agent === "tablet" ? <br /> : undefined} 알레르기와{" "}
                  {agent === "pc" ? <br /> : undefined} 호흡기 질환을 초래
                </b>
                합니다.
              </>
            ) : type === "bird" ? (
              <>
                비둘기 배설물이 옮기는 박테리아는 최소 6가지,
                {agent === "mb" ? <br /> : undefined} 진균 3가지,{" "}
                {agent !== "mb" ? <br /> : undefined}
                바이러스 2가지, 기생충 2가지 이상이
                {agent === "mb" ? <br /> : undefined} 존재합니다.{" "}
                {agent !== "mb" ? <br /> : undefined} 이로 인해{" "}
                <b>
                  발생할 수 있는 질병은{agent === "mb" ? <br /> : undefined}{" "}
                  무려 60여 가지이며 {agent !== "mb" ? <br /> : undefined}{" "}
                  사람에게 심한 해가 되는
                  {agent === "mb" ? <br /> : undefined} 미생물도 많습니다.
                </b>
              </>
            ) : type === "bug" ? (
              <>
                새로 지은 집에서 발생되는 환경호르몬이 입주자에게
                {agent === "mb" ? <br /> : undefined} 건강이상을{" "}
                {agent !== "mb" ? <br /> : undefined}
                유발하게 하는 새집증후군 제거 및 각종
                {agent === "mb" ? <br /> : undefined} 질병 및 전염병의 원인이
                되는 {agent !== "mb" ? <br /> : undefined} 각종 해충들의 종류,
                {agent === "mb" ? <br /> : undefined} 서식처, 생장주기, 발생장소
                등{" "}
                <b>
                  환경적 요인을 {agent !== "mb" ? <br /> : undefined} 전문가가
                  {agent === "mb" ? <br /> : undefined} 정확히 진단하여 1:1 통합
                  맞춤 방제 솔루션을 제공
                </b>

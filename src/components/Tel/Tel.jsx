  ...
  return (
    <div className="tel">
      ...
      <div className="bottom">
        <div className="pack">
          <div className="title">
            <b>깨끗한 환경</b>으로 <b>건강한 내일</b>을{" "}
            {agent === "mb" ? <br /> : undefined} 약속하는{" "}
            {agent !== "mb" ? <br /> : undefined} 에버퓨리가 여러분의{" "}
            {agent === "mb" ? <br /> : undefined} 건강을 지켜드립니다
          </div>
          <div className="call-wrapper">
            <div className="tel-wrapper">
              <img src="/assets/main/tel.svg" alt="전화" />
              <div className="tel-content">1522-4396</div>
            </div>
            <div className="address">
              대구광역시 동구 동내로 76{agent !== "pc" ? <br /> : undefined}{" "}
              한국메디벤처센터 210호, 211호
            </div>
          </div>

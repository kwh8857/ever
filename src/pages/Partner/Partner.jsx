                  ...
                  return (
                    <div key={idx} className="card">
                      ...
                      <div className="sub">
                        {idx === 0 ? (
                          <>
                            체계적인 교육을 통해 <br /> 에버퓨리만의{" "}
                            <b>
                              친환경 청소와 <br /> 시공 기술을 전수
                            </b>
                            합니다
                          </>
                        ) : idx === 1 ? (
                          <>
                            <b>
                              4주 간의 이론 교육과 실습·현장 <br /> 동행
                            </b>
                            을 통해 전문기술을 익힐 수 <br /> 있습니다. 관련
                            분야 경험이 없고, <br />
                            <b>
                              힘쓰는 일에 자신이 없더라도 <br /> 케어전문가로
                              거듭
                            </b>
                            날 수 있습니다.
                          </>
                          ...
                          <>
                            ...
                            으로 여성이 <br /> 하기에도 적합합니다.
                          </>
                        ) : (
                          <>
                            고객님 댁의 건강을 지킨다는 <br /> 마음으로{" "}
                            <b>
                              서비스를 제공할 열정을 <br /> 가진 많은 분들
                              도전을 기대
                            </b>
                            합니다
                          </>
            ...
            <div className="pack">
              ...
              <div className="two">
                ...
                <div className="sub">
                  ...
                  여러 기종의 제품 보유로 다양한 경험을 쌓으실 수 있습니다
                </div>
                <div className="img-wrapper">
                    ...
                    <div key={idx} className={`card ${name}`}>
                      ...
                      <div className="content">
                        ...
                        <div className="sub">
                          {name === "first" ? (
                            <>
                              바이러스, 미세먼지, 발암물질 처리 등 시대적 흐름에
                              <br />
                              맞는 기술을 개발해 현장에 적용할 수 있도록
                              <b>
                                {" "}
                                지속적인 <br />
                                교육을 무상 제공
                              ...
                              합니다. 특히 최신 가전제품에 맞는
                              <br />
                              기술 정보를 계속 업그레이드 해 당황하지 않고{" "}
                              <b>
                                어떤
                                <br />
                                현장에서건 최고의 청소 효과를 낼 수 있도록
                                돕겠습니다.
                              </b>
                            </>
                          ) : name === "second" ? (
                            <>
                              ...
                              서비스에 <br /> 임하실 수 있도록{" "}
                              <b>고객 유치를 위한 홍보를 지원</b> 합니다. <br />
                              <b>
                                기업, 관공서에 에버퓨리 케어서비스를 제안하고
                                각종 <br /> 광고를 통해 일반 소비자들이 쉽게
                                찾아올 수 있도록
                              </b>
                              <br /> 에버퓨리가 최선을 다하겠습니다.
                            </>
                            ...
                            <>
                              견적서 등 서류 작업이 필요할 경우 <br />{" "}
                              <b>에버퓨리에서 작성 요령을 제공</b> 합니다.
                            </>
                          )}
                        </div>
                      </div>

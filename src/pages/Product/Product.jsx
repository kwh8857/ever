...
여기까지 왔습니다.`}
        ...
        <div className="washing">
          ...
          <Kind type="wash" arr={kindArr} agent={agent} />
          <Reviews
            title={`세탁기 분해세척은
에버퓨리에 믿고 맡기세요!`}
            sub={`완벽한 홈케어로 입소문 타고 평판만으로 
...
여기까지 왔습니다.`}
        ...
        <div className="filter">
          ...
          />
          <Point type="hood" arr={pointArr3} agent={agent} />
          <Kind type="filter" arr={["공기정화장치", "디퓨저"]} agent={agent} />
          <Reviews
            title={`공기정화장치 필터 교체은
에버퓨리에 믿고 맡기세요!`}
            sub={`완벽한 홈케어로 입소문 타고 평판만으로 
...
에버퓨리에서는 1차 고압세척,
2차 고온스팀으로 세균을 박멸합니다.`,
    tabletsub: `세탁기 내부의 세균은 화장실
변기에 비해 100배가 넘는 세균이 
서식하고 있습니다. 에버퓨리에서는
 1차 고압세척, 2차 고온스팀으로 
세균을 박멸합니다.`,
    mbsub: `세탁기 내부의 세균은 화장실 변기에 비해 
100배가 넘는 세균이 서식하고 있습니다. 
에버퓨리에서는 1차 고압세척, 2차 고온
스팀으로 세균을 박멸합니다.`,
  },
  {
...
제거하여 악취의 원인을 제거합니다.`,
    tabletsub: `각종 세균,곰팡이,세제찌꺼기,
이물질을 제거하여 악취의 원인을 
제거합니다.`,
    mbsub: `각종 세균,곰팡이,세제찌꺼기,이물질을
제거하여 악취의 원인을 제거합니다.`,
  },
  {
    img: "/assets/product/care02-3.svg",
...
무리를 주지 않아 수명을 연장시킵니다.`,
    tabletsub: `세탁물의 이물질,세제로 인한 오염, 
찌꺼기를 제거 해줌으로 인해 
모터에 무리를 주지 않아 
수명을 연장시킵니다.`,
    mbsub: `세탁물의 이물질,세제로 인한 오염, 찌꺼기를
제거 해줌으로 인해 모터에 무리를 주지 않아 
수명을 연장시킵니다.`,
  },
];
const hoodCare02 = [
...
기름때로 인해 악취 및 고장, 화재
질병 등을 초래하게 됩니다.`,
    mbsub: `주방 후드의 외관은 깨끗해보여도 손이 닿지 
않는 내부의 오염물질 및 기름때로 인해
악취 및 고장, 화재 질병 등을 초래하게 됩니다.`,
  },
  {
    img: "/assets/product/care02-5.svg",
    title: `주방 내
...
꼼꼼하게 청소하여
주방 내 악취를 제거합니다.`,
    tabletsub: `눈에 보이지 않는 오염물질까지
꼼꼼하게 청소하여 주방 내 
악취를 제거합니다.`,
    mbsub: `눈에 보이지 않는 오염물질까지 꼼꼼하게 
청소하여 주방 내 악취를 제거합니다.`,
  },
  {
    img: "/assets/product/care02-2.svg",
...
및 오염 환경에 노출됩니다.
 `,
    mbsub: `주방후드를 청소하지 않으면 동일 전력 사용량 
대비 환기 효율이 떨어져 전기료 상승 및 
오염 환경에 노출됩니다.`,
  },
  {
...
번식하기 쉬워, 꼼꼼한 분해 청소로
세균과 해충 번식을 예방합니다.`,
    mbsub: `눈에 보이지 않는 깊숙한 부분인 만큼 세균과 
해충이 번식하기 쉬워, 꼼꼼한 분해 청소로
세균과 해충 번식을 예방합니다.`,
  },
];
const airCare02 = [
...
묵은 오염 물질이 더해져 보다
심각한 실내 공해를 유발합니다.`,
    tabletsub: `오염된 공기를 청정시켜주는 
공기청정기가 오염되었을 때 
공기청정기 내부에 있는 묵은
오염 물질이 더해져 보다 심각한 
실내 공해를 유발합니다.`,
    mbsub: `오염된 공기를 청정시켜주는 공기청정기가 
오염되었을 때 공기청정기 내부에 있는 묵은
오염 물질이 더해져 보다 심각한 실내 공해를 
유발합니다.`,
  },
  {
...
직접적인 영향을 주기 때문에
더욱 꼼꼼히 관리하여야합니다.`,
    mbsub: `공기중 오염물질은 호흡기에 직접적인 영향을 
주기 때문에 더욱 꼼꼼히 관리하여야합니다.`,
  },
];
const filterCare02 = [
  {
...
오히려 공기오염과 곰팡이를 유발하여
심각한 실내 공해를 유발합니다.`,
    tabletsub: `공기정화장치 (전열교환기)를 
청소하지 않을 시, 필터와 관로가
오염되어 오히려 공기오염과
곰팡이를 유발하여 심각한 
실내 공해를 유발합니다.`,
    mbsub: `공기정화장치 (전열교환기)를 청소하지 않을 시, 
필터와 관로가 오염되어 오히려 공기 오염과 
곰팡이를 유발하여 심각한 실내 공해를 
유발합니다.`,
  },
  {
    img: "/assets/product/care02-9.svg",
